...
def determine_return_legs(payload):
    """
    Gets outbound leg id, and linearly searches for return legs in the fares list 
    that match with the outbound leg id.
    Returns list of viable return legs.
    """
...
def post_response(payload, test_url, headers, viable_legs):
    ...
    response = {"header": {"token": result_token},
                "data": {"return_leg_ids": viable_legs}}
